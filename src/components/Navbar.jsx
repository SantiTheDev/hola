...
import { logo, menu, close, ojedasodev } from "../assets";
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        >
          <img src={ojedasodev} alt="logo" className="w-9 h-9 object-contain" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex">
            Santiago &nbsp;
            <span className="sm:block hidden">| Ojedasodev</span>
          </p>
        </Link>
        <ul
        ...
        <div className="sm:hidden flex felx-1 justify-end items-center">
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            } p-6 black-gradient absolute top-20 rigth-0 mx-2 my-2 min-w-[140px]
            z-10 rounded-lg`}
          >
